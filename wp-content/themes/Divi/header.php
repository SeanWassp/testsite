		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<?php if ( '' !== ( $et_email = et_get_option( 'header_email' ) ) ) : ?>
					<a  class="top-header-email" href="<?php echo esc_attr( 'mailto:' . $et_email ); ?>"><?php echo esc_html( $et_email ); ?></a>
				<?php endif; ?>
				</div>
			<?php endif; // true === $et_contact_info_defined ?>
				...
				<div class="triangle-styling-topheader">
					<a class="lets-chat-anchor" href="http://localhost:8888/Wassp/about-contact/#get-in-touch-form"><img  class="lets-chat-image" src="http://localhost:8888/Wassp/wp-content/uploads/2022/04/triangle-letschat.png"></a>
				</div>
